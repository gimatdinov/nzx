...
public class NZXConfigService {
    ...
    private final Map<String, Config> routes = new HashMap<>();
    ...
    public NZXConfigService(File nzxConfig, Tracer tracer) throws URISyntaxException, IOException {
        ...
        this.nzx = new NZXConfig(new JSONObject(cleanCfg.toString()), routes);
        ...
        tracer.trace("Config.Routes", routes.keySet().toString());
    }
    ...
    public Config getNode(String path) {
